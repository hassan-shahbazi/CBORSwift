...
class CBORSwiftTests: XCTestCase {
    ...
    func test_9_FinalComprehensiveTest_Encode() {
        ...
        let decoded: NSDictionary = [1: "687134968222EC17202E42505F8ED2B16AE22F16BB05B88C25DB9E602645F141".lowercased()
//                                     2:dic2,
//                                     3:dic3,
//                                     4:dic4
        ]
